...
export const updateRecipe = recipe => {
    ...
    const arrIngQuery = Array.from(document.querySelectorAll('.recipe__count'));
    arrIngQuery.forEach((el,i) => {
...
<div class="recipe__details">
    ...
    <div class="recipe__info">
        ...
        <div class="recipe__info-buttons">
            <button class="btn-tiny" id="btn-dec">
                <svg>
                    <use href="img/icons.svg#icon-circle-with-minus"></use>
                </svg>
            </button>
            <button class="btn-tiny" id="btn-inc">
                <svg>
